    ...
    return (
      <Shell withNav>
        ...
        {isStaff && (
          <button
            onClick={onOpenAdmin}
            style={{ width: "100%", background: "#1B2A4A", border: "none", color: "#fff", padding: "14px", borderRadius: 10, cursor: "pointer", fontWeight: 600, fontSize: "15px", fontFamily: SANS, marginBottom: "1rem", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}
          >
