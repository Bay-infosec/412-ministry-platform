    ...
    <div style={{
      ...
      <div style={{
        ...
        <img
          src="/logo.png"
          alt="412 Ministry"
          style={{ width: 80, height: 80, borderRadius: 18, objectFit: "cover", marginBottom: "1.25rem", border: "2.5px solid rgba(255,77,0,0.6)", boxShadow: "0 0 0 6px rgba(255,77,0,0.12), 0 12px 32px rgba(0,0,0,0.3)" }}
        />
