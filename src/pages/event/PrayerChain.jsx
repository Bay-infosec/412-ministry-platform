  ...
  return (
    <Shell withNav>
      ...
      <div style={{ marginBottom: "1.25rem" }}>
        ...
        <div style={{ fontFamily: SANS, fontSize: "24px", fontWeight: 600, color: "#1B2A4A", lineHeight: 1.2, marginBottom: "0.5rem" }}>
      ...
      {/* Scripture */}
      <div style={{ background: "#1B2A4A", borderRadius: 14, padding: "1rem 1.25rem", marginBottom: "1.25rem" }}>
        ...
        <div style={{ marginBottom: "1.25rem" }}>
          ...
          <div style={{ display: "flex", gap: 10 }}>
            {myDates.map((date, idx) => {
              ...
              return (
                <div key={idx} style={{
                  flex: 1, background: isToday ? "#FF4D00" : "#1B2A4A", borderRadius: 14,
      ...
      <div style={{ marginBottom: "1.25rem" }}>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontFamily: SANS, fontSize: "20px", fontWeight: 600, color: todayEntry?.teamNum === "all" ? "#1A4FBF" : "#1B2A4A" }}>
              August 3
      ...
      <div style={{ marginBottom: "1.25rem" }}>
        ...
        >
          <span style={{ fontSize: "13px", fontWeight: 700, color: "#1B2A4A" }}>Full Prayer Schedule</span>
        ...
        {scheduleOpen && (
          <div style={{
              ...
              return (
                <div key={teamNum} style={{
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 3 }}>
                    <div style={{ fontSize: "12px", fontWeight: 700, color: isMine ? "#FF4D00" : "#1B2A4A", fontFamily: SANS }}>
                      Team {teamNum}
                    </div>
                    {isTodayTeam && (
                  ...
                  <div style={{ fontSize: "11px", color: isMine ? "#1B2A4A" : TSEC, fontFamily: SANS, lineHeight: 1.5 }}>
            ...
            <div style={{
              ...
              <div style={{ fontSize: "12px", fontWeight: 700, color: todayEntry?.teamNum === "all" ? "#1A4FBF" : "#1B2A4A", fontFamily: SANS }}>
                All Teams Together
              </div>
      ...
      <div style={{ marginBottom: "1.25rem" }}>
        ...
        >
          <span style={{ fontSize: "13px", fontWeight: 700, color: "#1B2A4A" }}>What to pray for</span>
          ...
          <div style={{ border: `1px solid ${BORDER}`, borderTop: "none", borderRadius: "0 0 14px 14px", overflow: "hidden" }}>
            {PRAYER_TOPICS.map((topic, i) => (
              <div key={i} style={{
                ...
                <div style={{ fontSize: "13px", color: "#1B2A4A", fontFamily: SANS, lineHeight: 1.6 }}>
                  {topic}
                </div>
              </div>
            ))}
