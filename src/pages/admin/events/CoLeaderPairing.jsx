  ...
  return (
    <div>
      ...
      {modal === "pair" && pendingA && pendingB && (
        <div style={overlay}>
          <div style={sheet}>
            <div style={{ fontFamily: SERIF, fontSize: "22px", fontWeight: 600, color: NAVY, marginBottom: "1rem" }}>
              Confirm Pairing
            </div>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              <button onClick={() => { setModal(null); setPendingA(null); setPendingB(null); setSelectedId(null); }} style={{
                ...
                padding: "12px", fontSize: "14px", fontWeight: 600, color: NAVY,
                cursor: "pointer", fontFamily: SANS,
              }}>Cancel</button>
              <button onClick={confirmPair} disabled={busy} style={{
                flex: 1, background: busy ? "#C9B7A8" : NAVY, border: "none", borderRadius: 10,
...
function LeaderChip({ leader }) {
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 6, flex: 1, minWidth: 0 }}>
      ...
      <div style={{
        fontSize: "13px", fontWeight: 600, color: NAVY, fontFamily: SANS,
...
function LeaderCard({ leader }) {
  ...
  return (
    <div style={{ flex: 1, textAlign: "center" }}>
      ...
      <div style={{ fontSize: "13px", fontWeight: 600, color: NAVY, fontFamily: SANS, marginTop: 4 }}>
        {p.full_name?.split(" ")[0]}
      </div>
    </div>
  );
